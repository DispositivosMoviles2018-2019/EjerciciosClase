package uce.edu.ec.firebasedm.service;
...
import uce.edu.ec.firebasedm.R;
...
public class MyFirebaseInstanceService extends FirebaseMessagingService {
    ...
    private void showNotificacion(String title, String body) {
        ...
        String NOTIFICATION_CHANNEL_ID = "uce.edu.ec.firebasedm.test";
        ...
        NotificationCompat.Builder notificaBuilder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID);
